// game.js - główna logika gry z przemianowanymi trybami

const canvas = document.getElementById('gameCanvas');
const ctx = canvas.getContext('2d');

// Stan gry - obsługuje przemianowane tryby
let gameMode = null; // 'duell' (stary tournament) lub 'zweite_bundesliga' (stary friendly)
...
// Funkcja do uzyskania obecnych danych drużyny
function getCurrentTeamData() {
    if (gameMode === 'duell') {
        // 1 vs 1 DUELL - wybór przeciwnika z duellTeams (używa selectedTeam, nie currentRound)
        return duellTeams[selectedTeam];
    } else if (gameMode === 'zweite_bundesliga') {
        // ZWEITE BUNDESLIGA - wybór przeciwnika z teams
