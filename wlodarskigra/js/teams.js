...
},
{
    ...
    },
    {
        ...
        bots: [
            ...
            { name: "KAHN", x: 750, y: 200, color: "#080808", maxSpeed: 1.8, number: , role: "goalkeeper", isGoalkeeper: true, preferredY: 200, team: "opponent" },
            { name: "KOHLER", x: 700, y: 120, color: "#080808", maxSpeed: 1.8, number: , role: "fullback", preferredY: 120, team: "opponent" },
            { name: "HELMER", x: 720, y: 160, color: "#080808", maxSpeed: 1.5, number: , role: "centerback", preferredY: 160, team: "opponent" },
            { name: "REUTER", x: 720, y: 240, color: "#080808", maxSpeed: 1.5, number: , role: "centerback", preferredY: 240, team: "opponent" },
            { name: "ZIEGE", x: 700, y: 280, color: "#080808", maxSpeed: 1.8, number: , role: "fullback", preferredY: 280, team: "opponent" },
            { name: "ELITS", x: 650, y: 140, color: "#080808", maxSpeed: 2.0, number: , role: "defensive_midfielder", preferredY: 140, team: "opponent" },
            { name: "STRUNZ", x: 650, y: 260, color: "#080808", maxSpeed: 2.0, number: , role: "defensive_midfielder", preferredY: 260, team: "opponent" },
            { name: "MOLLER", x: 580, y: 120, color: "#080808", maxSpeed: 2.5, number: , role: "winger", preferredY: 120, team: "opponent" },
            { name: "HASLER", x: 580, y: 280, color: "#080808", maxSpeed: 2.5, number: , role: "winger", preferredY: 280, team: "opponent" },
            { name: "KLINSMANN", x: 520, y: 170, color: "#080808", maxSpeed: 2.8, number: , role: "striker", preferredY: 170, team: "opponent" },
            { name: "BIERHOFF", x: 520, y: 230, color: "#080808", maxSpeed: 2.8, number: , role: "striker", preferredY: 230, team: "opponent" },

            // DRUŻYNA GRACZA (9 zawodników z pola + Włodarski + bramkarz)
            { name: "WOJTALA", x: 100, y: 120, color: "#ff0000", maxSpeed: 1.8, number: , role: "fullback", preferredY: 120, team: "player" },
            { name: "JÓŹWIAK", x: 120, y: 160, color: "#ff0000", maxSpeed: 1.5, number: , role: "centerback", preferredY: 160, team: "player" },
            { name: "ZIELIŃSKI", x: 120, y: 240, color: "#ff0000", maxSpeed: 1.5, number: , role: "centerback", preferredY: 240, team: "player" },
            { name: "HAJTO", x: 100, y: 280, color: "#ff0000", maxSpeed: 1.8, number: , role: "fullback", preferredY: 280, team: "player" },
            { name: "CZERWIEC", x: 150, y: 140, color: "#ff0000", maxSpeed: 2.0, number: , role: "defensive_midfielder", preferredY: 140, team: "player" },
            { name: "MICHALSKI", x: 150, y: 260, color: "#ff0000", maxSpeed: 2.0, number: , role: "defensive_midfielder", preferredY: 260, team: "player" },
            { name: "BRZĘCZEK", x: 200, y: 200, color: "#ff0000", maxSpeed: 2.3, number: , role: "attacking_midfielder", preferredY: 200, team: "player" },
            { name: "WARZYCHA", x: 220, y: 120, color: "#ff0000", maxSpeed: 2.5, number: , role: "winger", preferredY: 120, team: "player" },
            { name: "KOWALCZYK", x: 220, y: 280, color: "#ff0000", maxSpeed: 2.5, number: , role: "winger", preferredY: 280, team: "player" }
        ],
        playerGoalkeeper: { name: "SZCZESNY", x: 50, y: 200, color: "#cc0000", maxSpeed: 2.0, number:, role: "goalkeeper" }
    }
];
