...
let state = {
  ...
  settings: {
    // 'full' (domyślnie) — mecze innych drużyn grane tym samym, pełnym
    // silnikiem co Twój mecz: prawdziwi strzelcy, podgląd przebiegu.
    // 'quick' — szybki, statystyczny rzut kostką (bez strzelców/przebiegu).
