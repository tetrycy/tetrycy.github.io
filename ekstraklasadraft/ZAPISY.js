...
function loadGameSlot(id) {
  ...
  state.settings.otherMatchesEngine = 'full'; // migracja starych zapisów: szybki silnik już nie istnieje
  migrateAndPruneComputerMatchReplays();
...
function quickMatch() {
  ...
  state = {
    ...
    speed: keepSpeed, commentaryStyle: keepStyle, tournamentPhase: 'knockout', mundial: null, mundialVariant: 'champions',
    myClub: teamA.club, fogOfWar: false, fogOfWarApplied: false, settings: keepSettings, isQuickMatch: true,
  };
