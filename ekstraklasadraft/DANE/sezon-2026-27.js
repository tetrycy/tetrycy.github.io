// ============================================================
// SEZON 2026/27 — 2 kluby
// Część bazy TEAMS_DATA — każdy sezon w osobnym pliku.
// Overalle startowe wyliczone z wartości rynkowych z pliku źródłowego.
// ============================================================
...
window.TEAMS_DATA.push(
{
  ...
  players: [
    { name: "Mrozek",            position: "GK",  overall: 82, apps: 0, goals: 0,  starting: false, "birthYear": 2000 },
    { name: "Lis",               position: "GK",  overall: 85, apps: 0, goals: 0,  starting: true, "birthYear": 1997 },


    { name: "Mońka",             position: "DEF",  overall: 90, apps: 0, goals: 0,  starting: true, "birthYear": 2007 },
    { name: "Yegbe",             position: "DEF",  overall: 86, apps: 0, goals: 0,  starting: true, "birthYear": 2001 },
    { name: "Douglas",           position: "DEF",  overall: 77, apps: 0, goals: 0,  starting: false, "birthYear": 2001 },
    { name: "Skrzypczak",        position: "DEF",  overall: 71, apps: 0, goals: 0,  starting: false, "birthYear": 2000 },
    { name: "Gurgul",            position: "DEF",  overall: 78, apps: 0, goals: 0,  starting: false, "birthYear": 2006 },
    { name: "Moutinho",          position: "DEF",  overall: 75, apps: 0, goals: 0,  starting: false, "birthYear": 1998 },
    { name: "Pereira",           position: "DEF",  overall: 84, apps: 0, goals: 0,  starting: true, "birthYear": 1996 },
    { name: "Gumny",             position: "DEF",  overall: 79, apps: 0, goals: 0,  starting: true, "birthYear": 1998 },
    { name: "Hoffmann",          position: "DEF",  overall: 63, apps: 0, goals: 0,  starting: false, "birthYear": 2001 },
    ...
    { name: "Palma",             position: "MID",  overall: 87, apps: 0, goals: 0,  starting: true, "birthYear": 2000 },
    { name: "Bengtsson",         position: "MID",  overall: 83, apps: 0, goals: 0,  starting: true, "birthYear": 1998 },
    { name: "Hĺkans",            position: "FWD",  overall: 71, apps: 0, goals: 0,  starting: false, "birthYear": 2000 },
    { name: "Sayyadmanesh",      position: "FWD",  overall: 86, apps: 0, goals: 0,  starting: true, "birthYear": 2001 },
    { name: "Gholizadeh",        position: "MID",  overall: 72, apps: 0, goals: 0,  starting: false, "birthYear": 1996 },
    { name: "Agnero",            position: "FWD",  overall: 78, apps: 0, goals: 0,  starting: false, "birthYear": 2003 },
    { name: "Ishak",             position: "FWD",  overall: 91, apps: 0, goals: 0,  starting: true, "birthYear": 1993 },
    { name: "Fiabema",           position: "FWD",  overall: 70, apps: 0, goals: 0,  starting: false, "birthYear": 2003 },
...
,
{
  ...
  players: [
    ...
    { name: "Sadilek",           position: "MID",  overall: 79, apps: 0, goals: 0,  starting: false, "birthYear": 1996 },
