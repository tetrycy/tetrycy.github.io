...
function confirmRealTeam() {
  ...
  state = { squad: {}, rerolls: 2, currentTeam: null, usedTeams: new Set(), bracket: [], roundIdx: 0, myOverall: 0, speed: keepSpeed, commentaryStyle: keepStyle, tournamentPhase: 'knockout', mundial: null, mundialVariant: 'champions', myClub: club, fogOfWar: false, fogOfWarApplied: false, settings: keepSettings };
...
function startDraft() {
  ...
  state = { squad:{}, rerolls:2, currentTeam:null, usedTeams:new Set(), bracket:[], roundIdx:0, myOverall:0, speed: keepSpeed, commentaryStyle: keepStyle, tournamentPhase:'knockout', mundial:null, mundialVariant:'champions', fogOfWar, fogOfWarApplied: false, settings: keepSettings };
