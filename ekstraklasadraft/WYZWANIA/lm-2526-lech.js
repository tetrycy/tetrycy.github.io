// ============================================================
// LECH POZNAŃ W LIDZE MISTRZÓW 2026/27 — system szwajcarski Z KOSZYKAMI
...
// wyjeździe). Lech Poznań zajmuje swoje stałe miejsce w KOSZYKU 4.
//
// 3 rundy eliminacji: 1. runda ze stałym rywalem (Aarhus GF), 2. i 3.
...
// Wymaga: WYZWANIA/druzyny-lm-2526.js oraz klubu "Lech Poznań" w sezonie
...
window.WYZWANIA.push({
  id: 'lm-2526-lech',
  title: 'Lech Poznań w Lidze Mistrzów 2026/27',
  description: 'Przeprowadź Lech Poznań przez 3 rundy eliminacji (od Aarhus GF) i nową Ligę Mistrzów z prawdziwym losowaniem koszykowym: 8 meczów fazy ligowej, baraże, drabinka — aż po finał.',
  club: 'Lech Poznań',
  clubSeason: '2026/27',
  type: 'swiss',

  qualifying: [
    { name: 'II runda eliminacji', legs: 2, firstLegHome: true, opponent: { source: 'custom', id: 'lm2-aarhus' } },
    {
      name: 'III runda eliminacji', legs: 2, firstLegHome: false,
      opponentPool: [
        { source: 'custom', id: 'lm2-pool-maccabi' },
        { source: 'custom', id: 'lm2-pool-ludogorets' },
        { source: 'custom', id: 'lm2-pool-malmo' },
        { source: 'custom', id: 'lm2-pool-hjk' },
        { source: 'custom', id: 'lm2-pool-zrinjski' },
        { source: 'custom', id: 'lm2-pool-servette' },
        { source: 'custom', id: 'lm2-pool-shamrock' },
        { source: 'custom', id: 'lm2-pool-kups' }
      ],
    },
    {
