...
function openPiszpad() {
    window.open('https://www.tetrycy.com.pl/piszpad/index.html', '_blank', 'width=900,height=700,resizable=yes,scrollbars=yes');
}
...
case 'jakub-olkiewicz':
    window.open('https://tetrycy.github.io/felietony-kuby/olkiewicz19.html', '_blank', 'width=700,height=500,resizable=yes,scrollbars=yes');
    break;
...
case 'fanatyk-pilkarstwa':
    window.open('https://www.youtube.com/watch?v=_c1p8JcCCqc&t=11s', '_blank');
    break;
